...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void GamePlayManager_levelComplete_mBA1A44469AEF4EF308ECFBC80A35CBD55355A902 (GamePlayManager_tB470F0B321EF1C06EA84E5365E8BC759478FFA42* __this, const RuntimeMethod* method) 
{
	...
	{
		// S_Complete.Play();
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_3 = __this->___S_Complete_21;
		NullCheck(L_3);
...
IL_0032:
	{
		...
		RuntimeObject* L_4;
		L_4 = GamePlayManager_LevelCompleted_m335A47ECB13C23E7F2186DF685ADDCC163240D16(__this, NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void GamePlayManager_levelFail_mCA80DB5D76FD5E512B855CD78A52F128B245B5BA (GamePlayManager_tB470F0B321EF1C06EA84E5365E8BC759478FFA42* __this, const RuntimeMethod* method) 
{
	...
	{
		// S_Failed.Play();
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_3 = __this->___S_Failed_22;
		NullCheck(L_3);
		AudioSource_Play_m95DF07111C61D0E0F00257A00384D31531D590C3(L_3, NULL);
	}
...
IL_002b:
	{
		...
		RuntimeObject* L_4;
		L_4 = GamePlayManager_LevelFailed_mDA6DD23823665304B86C60DB5D9CBABA5ADDA4AD(__this, NULL);
		Coroutine_t85EA685566A254C23F3FD77AB5BDFFFF8799596B* L_5;
		L_5 = MonoBehaviour_StartCoroutine_m4CAFF732AA28CD3BDC5363B44A863575530EC812(__this, L_4, NULL);
		// }
		return;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void GamePlayManager_Skip_m617FE82DC59A124672B0A764BE7F669803B918FC (GamePlayManager_tB470F0B321EF1C06EA84E5365E8BC759478FFA42* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void StoreManager_Start_m06BA4C37BD04BAAA47131FDFA341EA661E740B04 (StoreManager_t1F347E0FAC21A65F295C448A68E7C1A6317FEF32* __this, const RuntimeMethod* method) 
{
	...
	{
		// Cointxt.text = PlayerPrefs.GetInt("Coins").ToString();
		Text_tD60B2346DAA6666BF0D822FF607F0B220C2B9E62* L_0 = __this->___Cointxt_7;
		int32_t L_1;
		L_1 = PlayerPrefs_GetInt_m4D859DBEABAD3FB406C94485A0B2638A0C7F2987(_stringLiteral1A4EE5BEF65324F81F44FB871AD37A4741D69B15, NULL);
		V_0 = L_1;
		String_t* L_2;
...
IL_0032:
	{
		...
		GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_5 = __this->___ShibaLocker_4;
		int32_t L_6 = V_2;
		NullCheck(L_5);
		int32_t L_7 = L_6;
...
IL_005e:
	{
		...
		ImageU5BU5D_t8869694C217655DA7B1315DC02C80F1308B78B78* L_13 = __this->___SelectedShiba_9;
		int32_t L_14 = V_4;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_15 = __this->___contant_8;
		NullCheck(L_15);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_16;
		L_16 = GameObject_get_transform_m0BC10ADFA1632166AE5544BDF9038A2650C2AE56(L_15, NULL);
		int32_t L_17 = V_4;
...
IL_0086:
	{
		// for (int i = 0; i < contant.transform.childCount; i++)
		int32_t L_21 = V_4;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_22 = __this->___contant_8;
		NullCheck(L_22);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_23;
		...
		V_5 = (bool)((((int32_t)L_21) < ((int32_t)L_24))? 1 : 0);
		bool L_25 = V_5;
		if (L_25)
		{
			goto IL_005e;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void StoreManager_unlockShiba_mA3895D2FB31E0565F2D7B47D6280CC25F8F3039F (StoreManager_t1F347E0FAC21A65F295C448A68E7C1A6317FEF32* __this, int32_t ___num0, const RuntimeMethod* method) 
{
	...
	int32_t V_1 = 0;
	{
		...
		Int32U5BU5D_t19C97395396A72ECAF310612F0760F165060314C* L_1 = __this->___ShibaPrices_5;
		int32_t L_2 = ___num0;
		NullCheck(L_1);
	...
	}
	{
		...
		GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_7 = __this->___ShibaLocker_4;
		int32_t L_8;
		...
		Int32U5BU5D_t19C97395396A72ECAF310612F0760F165060314C* L_12 = __this->___ShibaPrices_5;
		...
		// Cointxt.text = PlayerPrefs.GetInt("Coins").ToString();
		Text_tD60B2346DAA6666BF0D822FF607F0B220C2B9E62* L_16 = __this->___Cointxt_7;
		int32_t L_17;
...
IL_0097:
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_21 = __this->___CoinWarning_6;
		NullCheck(L_21);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void StoreManager_selectShiba_mE86422058573CACF6AD30E3027C3E2E6420A5E08 (StoreManager_t1F347E0FAC21A65F295C448A68E7C1A6317FEF32* __this, int32_t ___ShibaNum0, const RuntimeMethod* method) 
{
	...
	Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* V_2 = NULL;
	{
		...
		ImageU5BU5D_t8869694C217655DA7B1315DC02C80F1308B78B78* L_1 = __this->___SelectedShiba_9;
		V_0 = L_1;
		V_1 = 0;
		goto IL_0053;
	}
...
IL_0053:
	...
	}
	{
		...
		ImageU5BU5D_t8869694C217655DA7B1315DC02C80F1308B78B78* L_12 = __this->___SelectedShiba_9;
